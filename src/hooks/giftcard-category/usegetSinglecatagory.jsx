...
import Categoryservices from "../../services/giftcard-category/admin";
...
const useGetSingleCategory = () => {
    ...
    const getSingleCategory = async (id) => {
        ...
        try {
            setloading(true);
            const res = await Categoryservices.getSingleCard(id, source.current.token );
    ...
    return {getSingleCategory, data, loading};
}
