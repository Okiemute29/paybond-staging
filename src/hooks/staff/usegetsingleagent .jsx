...
const useGetSingleAgent = () => {
    ...
    const getSingleAgent = async (id) => {
        ...
        try {
            setloading(true);
            const res = await Adminservices.getSingleAgent(id, source.current.token );
    ...
    return {getSingleAgent, data, loading};
}
 
export default useGetSingleAgent;