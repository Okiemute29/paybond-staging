...
import Countryservices from "../../services/giftcard-country/admin";
...
const useGetSingleCountry = () => {
    ...
    const getSingleCountry = async (id) => {
        ...
        try {
            setloading(true);
            const res = await Countryservices.getSingleCountry(id, source.current.token );
    ...
    return {getSingleCountry, data, loading};
}
