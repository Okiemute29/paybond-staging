...
import Productservices from "../../services/product/admin";
...
const useGetSingleProduct = () => {
    ...
    const getSingleProduct = async (id) => {
        ...
        try {
            setloading(true);
            const res = await Productservices.getSingleProduct(id, source.current.token );
    ...
    return {getSingleProduct, data, loading};
}
