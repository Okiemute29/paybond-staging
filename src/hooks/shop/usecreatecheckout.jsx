...
const usePostAddToCheckOut = () => {
    ...
    const addToCheckOut = async (data) => {
        ...
        try {
            setloading(true);
            const res = await Shopservices.createCheckOut(data, source.current.token);
    ...
    return {addToCheckOut, data, loading};
}
 
export default usePostAddToCheckOut;