...
const useGetDeliveryState = () => {
    ...
    const getDeliveryState = async (data) => {
        if (source.current === undefined) {
            source.current = CancelToken.source();
          }
        try {
            setloading(true);
            const res = await Shopservices.getState(source.current.token);
    ...
    return {getDeliveryState, data, loading};
}
 
export default useGetDeliveryState;