...
const usePostRemoveFromCart = () => {
    ...
    const removeFromCart = async (data) => {
        ...
        try {
            setloading(true);
            const res = await Shopservices.removeFromCart(data, source.current.token);
    ...
    return {removeFromCart, data, loading};
}
 
export default usePostRemoveFromCart;