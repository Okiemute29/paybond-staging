...
const useGetFromCart = () => {
    ...
    const getFromCart = async (data) => {
        if (source.current === undefined) {
            source.current = CancelToken.source();
          }
        try {
            setloading(true);
            const res = await Shopservices.getFromCart(source.current.token);
    ...
    return {getFromCart, data, loading};
}
 
export default useGetFromCart;