...
const useDropFromCart = () => {
    ...
    const dropFromCart = async (data) => {
        if (source.current === undefined) {
            source.current = CancelToken.source();
          }
        try {
            setloading(true);
            const res = await Shopservices.dropFromCart(data, source.current.token);
    ...
    return {dropFromCart, data, loading};
}
 
export default useDropFromCart;