...
const useGetGroceriesAllOrder = () => {
    ...
    const getGroceriesAllOrder = async () => {
        if (source.current === undefined) {
            source.current = CancelToken.source();
          }
        try {
            setloading(true);
            const res = await Transactionservices.getAllGroceriesOrder(source.current.token );
    ...
    return {getGroceriesAllOrder, data, loading};
}
 
export default useGetGroceriesAllOrder;