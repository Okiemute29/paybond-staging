...
import Cryptoservices from "../../services/orders/admin";
...
const useUpdateOrder = () => {
    ...
    const upDateOrder = async ( id, data) => {
        ...
        try {
            setloading(true);
            const res = await Cryptoservices.UpdateOrder(data, id, source.current.token );
    ...
    return {upDateOrder, data, loading};
}
