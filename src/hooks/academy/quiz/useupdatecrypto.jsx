...
import Quizservices from "../../../services/quiz/admin";
...
const useUpdateQuiz = () => {
    ...
    const upDateQuiz = async (data, id) => {
        if (source.current === undefined) {
            source.current = CancelToken.source();
          }
        try {
            setloading(true);
            const res = await Quizservices.UpdateQuiz(data, id, source.current.token );
    ...
    return {upDateQuiz, data, loading};
}
