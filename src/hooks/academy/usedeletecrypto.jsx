...
const useDeleteAcademy = () => {
    ...
    const deleteAcademy = async (id) => {
        ...
        try {
            setloading(true);
            const res = await Academyservices.DeleteAcademy(id, source.current.token );
    ...
    return {deleteAcademy, data, loading};
}
 
export default useDeleteAcademy;