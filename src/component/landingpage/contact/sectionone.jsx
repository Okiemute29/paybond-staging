...
export default function SectionOne() {
	...
	return ( 
	<>
		<div className="nk-content cont-sectionone-bg ">
						...
						<div className="nk-block-head nk-block-head-sm mt-4 h-100">
							<div className="nk-block-between h-100">
								<div className='landing-section flex-column flex-md-row h-100'>
									...
									<h1 className='my-5 sec-title'>Connect with Ease, <br/>Resolve with Speed:  <br/><span className='text-paybond'> Your 24/7 Utility Hub!</span></h1>
										<ButtonSection />
									</div>
