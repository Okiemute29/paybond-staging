...
const ProductList = ({ products, loading, handleRemoveFromCart, handleAddToCart, cartData, addLoading, FavouriteData, handleRemoveFromFav, handleAddToFav, searchTerm, searchResult  }) => {
